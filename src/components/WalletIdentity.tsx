...
export function WalletIdentity({ wallet, link = true, explorer = true }: { wallet: string; link?: boolean; explorer?: boolean }) {
  ...
  const content = <><XAvatar key={profile.avatarUrl} profile={profile}/><span>@{profile.username}</span></>;
