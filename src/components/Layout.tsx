...
export function Layout({ children }: { children: ReactNode }) {
  ...
  const integrationsPage=currentPath === "/integrations" || currentPath.startsWith("/settings") || currentPath.startsWith("/profile/");
  ...
  return <div className={`app-shell ${trading ? "trading-shell" : ""} ${currentPath.startsWith("/studio")?"studio-shell":""} ${integrationsPage?"integrations-shell":""}`}>
    ...
    {!trading && !integrationsPage && <a className="community-reward-banner" href={COMMUNITY_POST_URL} target="_blank" rel="noreferrer">
      <CampaignBannerArt/>
