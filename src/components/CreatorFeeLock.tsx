  ...
  return <div className="creator-lock-manager">
    ...
    {formVisible&&<div className="manage-grid creator-lock-editor">
      <section className="manage-builder">
        <header><h2>{active?"Lock more supply":"Creator lock"}</h2><p>{active?"Add tokens from your wallet and choose a new duration for the combined balance.":"Commit supply to earn a share of the platform fee."}</p></header>
