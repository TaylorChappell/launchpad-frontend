...
export function Token() {
  ...
  return <main className="page token-page">
    <div className="token-market-toolbar"><Link className="back" to="/"><ArrowLeft/>Explore markets</Link><div className="token-market-actions"><GovernanceVote market={launch} compact/>{config.marketGovernanceEnabled && <MarketProposals launch={launch} corner/>}</div></div>
