      ...
      <article className="aqua-docs-content">
        ...
        <DocSection id="automatic-funds" eyebrow="MARKET GOVERNANCE" title="Use market momentum to fund visibility">
          ...
          <div className="aqua-docs-definition">
            ...
            <div><b>DEX profile paid: 10%</b><span>A mini boost fund starts with 90 minutes and gains 20 minutes at each boost milestone. It closes early after 30 quiet minutes. Under $100 at closing, all funds return to holders; from $100, it selects the largest affordable pack and returns the excess.</span></div>
