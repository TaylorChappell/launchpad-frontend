...
const typeLabel = (p: MarketProposal) => p.type === "dex_boost" ? "DEX boost" : p.type === "cto" ? "Community takeover" : p.type === "dex_update" ? "Update DEX" : "Fund DEX";
