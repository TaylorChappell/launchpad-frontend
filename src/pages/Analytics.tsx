  ...
  return <main className="page holder-workspace analytics-workspace">
    ...
    {!data?<div className="workspace-loading">{offline?"Analytics unavailable":"Loading AQUA activity…"}</div>:<>
      <section className="network-metrics">
        <article className="network-metric-featured"><span><Gift size={19}/> Holder rewards allocated</span><strong>{usd.format(data.totals.rewardsAccumulatedUsd)}</strong><small>Valued when allocated</small></article>
      ...
      <details className="workspace-disclosure"><summary>Claimed assets &amp; data details</summary><div>
        ...
        <p>Allocated rewards are valued when allocated. Buyback funding is assigned to buybacks; only verified purchases count as completed buybacks.</p>
